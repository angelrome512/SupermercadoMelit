...
class ProductoResourceIT {
    ...
    private static final TipoProducto UPDATED_TIPO_PRODUCTO = TipoProducto.CONGELADOS;
    ...
    void partialUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.codigo(UPDATED_CODIGO).nombre(UPDATED_NOMBRE).precioTotal(UPDATED_PRECIO_TOTAL);
