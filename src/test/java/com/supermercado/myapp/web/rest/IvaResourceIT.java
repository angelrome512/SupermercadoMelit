...
import com.supermercado.myapp.service.mapper.IvaMapper;
...
class IvaResourceIT {
    ...
    public static Iva createEntity(EntityManager em) {
        Iva iva = new Iva().tipo(DEFAULT_TIPO).valor(DEFAULT_VALOR);
        return iva;
    }
    ...
    public static Iva createUpdatedEntity(EntityManager em) {
        Iva iva = new Iva().tipo(UPDATED_TIPO).valor(UPDATED_VALOR);
        return iva;
    }
    ...
    void putNewIva() throws Exception {
        ...
        updatedIva.tipo(UPDATED_TIPO).valor(UPDATED_VALOR);
    ...
    void fullUpdateIvaWithPatch() throws Exception {
        ...
        partialUpdatedIva.tipo(UPDATED_TIPO).valor(UPDATED_VALOR);
